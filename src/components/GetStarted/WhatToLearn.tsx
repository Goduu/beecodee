            ...
            <div className='flex flex-wrap gap-16 items-center justify-center'>
                {currentQuestion.options.map((option, index) => (
                    <div
                        ...
                        className={`
                            relative flex flex-col items-center gap-2 border rounded-md p-4 w-32
...
const questions = [
    {
        ...
        options: [
            { id: 'javascript', label: "Javascript", icon: <SiJavascript className='w-16' />, released: true },
            { id: 'typescript', label: "Typescript", icon: <SiTypescript className='w-16' />, released: false },
            { id: 'html5', label: "HTML5", icon: <SiHtml5 className='w-16' />, released: false },
            { id: 'css', label: "CSS", icon: <SiCss3 className='w-16' />, released: false },
            { id: 'react', label: "React", icon: <SiReact className='w-16' />, released: false },
            { id: 'python', label: "Python", icon: <SiPython className='w-16' />, released: false },
        ]
    },
    {
        id: 1,
        ...
        options: [
            { id: 'beginner', label: "Beginner", icon: <MdStarHalf className='w-16' />, released: true },
            { id: 'intermediary', label: "Intermediary", icon: <MdStar className='w-16' />, released: true },
            { id: 'advanced', label: "Advanced", icon: <GiStarsStack className='w-16' />, released: true },
        ]
    }
]