...
const ACTIVITY_TYPES: NonNullable<ActivityType>[] = ["CodeOutputActivity", "FillInTheBlankActivity", "MultipleChoiceActivity", "PairMatchingActivity", "SingleChoiceActivity"]
