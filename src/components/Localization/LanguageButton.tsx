  ...
  return (
    <div className="relative hidden text-left sm:inline-block" ref={menuRef}>
      <button
        ...
        className="mb-3 inline-flex h-8 items-center  rounded-lg px-5 text-center text-sm font-medium text-white hover:bg-slate-100 focus:outline-none focus:ring-4 focus:ring-blue-300 dark:hover:bg-slate-500 dark:focus:ring-blue-800 md:mb-0"
        type="button"
      >
