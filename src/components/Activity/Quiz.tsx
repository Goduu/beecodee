...
export const Quiz: FC<ActivityProps> = ({ lessonXp, activityMap }) => {
    ...
    const isButtonDisabled = onGoingActivityData?.question.type === "PairMatchingQuestion" &&
        ...
        <>
            ...
            <LessonFooter
                ...
                onCheck={lessonState === "correct" ? handleGotToNextActivity
                    : lessonState === "completed" ? handleFinishLesson
                        :
                        lessonState === "wrong" ? () => setLessonState("none")
                            :
                            toggleCheckFlag}
                status={lessonState} />
        </>
